        ...
        <div class="mt-16">
          <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div class="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                <div>
                  <span class="flex h-10 w-10 items-center justify-center rounded-md bg-cyan-500">
                ...
                <div class="mt-6">
                  <h3 class="text-cyan-400 mt-6 text-sm font-medium">Strategic Planning</h3>
                  <p class="mt-2 font-semibold text-lg text-white">Develop a business strategy and set up company objectives.</p>
                  <p class="mt-3 text-base leading-7 text-gray-300">Semper curabitur ullamcorper posuere nunc sed. Ornare iaculis bibendum malesuada faucibus lacinia porttitor. Pulvinar laoreet sagittis viverra duis. In venenatis sem arcu pretium pharetra at. Lectus viverra dui tellus ornare pharetra.</p>
                  <div class="mt-6">
                    <!--button placeholder-->
                  </div>
                </div>
          ...
          <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div class="mx-auto max-w-xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                ...
                <div class="mt-6">
                  <h3 class="text-cyan-400 mt-6 text-sm font-medium">Team OKR</h3>
                  <p class="mt-2 font-semibold text-lg text-white">Collaborate with your teams to implement the strategy.</p>
                  <p class="mt-3 text-base leading-7 text-gray-300">Semper curabitur ullamcorper posuere nunc sed. Ornare iaculis bibendum malesuada faucibus lacinia porttitor. Pulvinar laoreet sagittis viverra duis. In venenatis sem arcu pretium pharetra at. Lectus viverra dui tellus ornare pharetra.</p>
                  <div class="mt-6">
                    <!--button placeholder-->
                  </div>
          ...
          <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div class="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                ...
                <div class="mt-6">
                  <h3 class="text-cyan-400 mt-6 text-sm font-medium">Enterprise Risk Management</h3>
                  <p class="mt-2 font-semibold text-lg text-white">Manage your risks and take opportunities.</p>
                  <p class="mt-3 text-base leading-7 text-gray-300">Semper curabitur ullamcorper posuere nunc sed. Ornare iaculis bibendum malesuada faucibus lacinia porttitor. Pulvinar laoreet sagittis viverra duis. In venenatis sem arcu pretium pharetra at. Lectus viverra dui tellus ornare pharetra.</p>
                  <div class="mt-6">
                    <!--button placeholder-->
                  </div>
